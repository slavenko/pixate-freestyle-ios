...
@implementation NFI_PXUIButton

#pragma mark - Static methods

+ (void)initialize
{
    if (self != NFI_PXUIButton.class)
        return;
...
- (NSArray *)pxStyleChildren
{
    ...
    {
        __weak NFI_PXUIButton *weakSelf = self;
...
- (NSArray *)viewStylers
{
    ...
    dispatch_once(&onceToken, ^{
        stylers = @[
            ...
            [[PXTextShadowStyler alloc] initWithCompletionBlock:^(NFI_PXUIButton *view, PXTextShadowStyler *styler, PXStylerContext *context) {
            ...
            [[PXFontStyler alloc] initWithCompletionBlock:^(NFI_PXUIButton *view, PXFontStyler *styler, PXStylerContext *context) {
                view.px_titleLabel.font = context.font;
            }],

            [[PXPaintStyler alloc] initWithCompletionBlock:^(NFI_PXUIButton *view, PXPaintStyler *styler, PXStylerContext *context) {
            ...
            [[PXInsetStyler alloc] initWithBaseName:@"content-edge" completionBlock:^(NFI_PXUIButton *view, PXInsetStyler *styler, PXStylerContext *context) {
                [view px_setContentEdgeInsets:styler.insets];
            }],
            [[PXInsetStyler alloc] initWithBaseName:@"title-edge" completionBlock:^(NFI_PXUIButton *view, PXInsetStyler *styler, PXStylerContext *context) {
                [view px_setTitleEdgeInsets:styler.insets];
            }],
            [[PXInsetStyler alloc] initWithBaseName:@"image-edge" completionBlock:^(NFI_PXUIButton *view, PXInsetStyler *styler, PXStylerContext *context) {
                [view px_setImageEdgeInsets:styler.insets];
            }],

            [[PXTextContentStyler alloc] initWithCompletionBlock:^(NFI_PXUIButton *view, PXTextContentStyler *styler, PXStylerContext *context) {
            ...
            [[PXGenericStyler alloc] initWithHandlers: @{
             @"text-transform" : ^(PXDeclaration *declaration, PXStylerContext *context) {
                NFI_PXUIButton *view = (NFI_PXUIButton *)context.styleable;
